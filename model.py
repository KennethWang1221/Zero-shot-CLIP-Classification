...
class CLIPModel(nn.Module):
    def __init__(
        ...
        self.image_projection = ProjectionHead(embedding_dim=self.image_embedding, projection_dim = self.projection_dim, dropout = self.dropout)
        self.text_projection = ProjectionHead(embedding_dim=self.text_embedding, projection_dim = self.projection_dim, dropout = self.dropout)
